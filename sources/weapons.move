module publisher::cryptara_conquest_weapons {
    ...
    struct Weapon has store, copy, drop, key {
        ...
        damage: u8,
        range: u8,
        price: u64,  // Changed to u64
        uri: String,
    }

    fun init_module(admin: &signer) {
        let weapons: vector<Weapon> = vector::empty();

        vector::push_back(&mut weapons, Weapon {
        ...
        move_to(&object::generate_signer(&collection_ref), Collection {
            soulbound: false,
            mintable: true,
